...
if [ $real_addr == $local_addr ] ; then
	...
	wget https://raw.githubusercontent.com/padavan01/trojan/master/trojan-1.14.0-linux-amd64.tar.xz
	tar xf trojan-1.*
	#下载trojan客户端
	wget https://raw.githubusercontent.com/padavan01/trojan/master/trojan-cli.zip
